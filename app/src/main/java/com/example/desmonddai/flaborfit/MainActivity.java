package com.example.desmonddai.flaborfit;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout yagaBtn = (RelativeLayout)findViewById(R.id.yogaBtn);
        ...
        yagaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
